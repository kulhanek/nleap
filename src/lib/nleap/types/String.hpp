#ifndef NLEAP_TYPE_STRING_HPP
#define NLEAP_TYPE_STRING_HPP
// =============================================================================
...
/// CString is a string type
/// value is accessible via VALUE property
class NLEAP_PACKAGE CString : public CEntity {
public:
...
typedef shared_ptr< CString > CStringPtr;
