#ifndef NLEAPSCMDS_DESC_H
#define NLEAPSCMDS_DESC_H
// =============================================================================
...
class CDescCommand : public CCommand {
public:

    CDescCommand(const string& cmd_name);

    CDescCommand(const string& cmd_name, string& obj);
