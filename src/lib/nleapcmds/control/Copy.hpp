#ifndef NLEAPSCMDS_COPY_H
#define NLEAPSCMDS_COPY_H
// =============================================================================
...
//------------------------------------------------------------------------------
/// copy an object as another object
/// \ingroup nleapcmds

class CCopyCommand : public CCommand {
public:

    CCopyCommand(const string& cmd_name);

    CCopyCommand(const string& cmd_name, const string& var_name, const string& srcvar_name);
