#ifndef NLEAPSCMDS_ADD_H
#define NLEAPSCMDS_ADD_H
// =============================================================================
...
public:
    ...
    CAddCommand(const string& cmd_name);

    CAddCommand(const string& cmd_name, CEntityPtr& dst_obj, CEntityPtr& src_obj);
