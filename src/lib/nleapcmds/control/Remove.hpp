#ifndef NLEAPSCMDS_REMOVE_H
#define NLEAPSCMDS_REMOVE_H
// =============================================================================
...
public:
    ...
    CRemoveCommand(const string& cmd_name);

    CRemoveCommand(const string& cmd_name, CEntityPtr& owner, CEntityPtr& object);
