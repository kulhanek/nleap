#ifndef NLEAPSCMDS_ENERGY_H
#define NLEAPSCMDS_ENERGY_H
// =============================================================================
...
class CEnergyCommand : public CCommand {
public:

    CEnergyCommand(const string& cmd_name);

    CEnergyCommand(const string& cmd_name, CEntityPtr& unit);
