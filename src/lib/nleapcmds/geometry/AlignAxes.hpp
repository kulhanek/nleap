#ifndef NLEAPSCMDS_ALIGN_AXES_H
#define NLEAPSCMDS_ALIGN_AXES_H
// =============================================================================
...
/// \ingroup nleapcmds
class CAlignAxesCommand : public CCommand {
public:

    CAlignAxesCommand(const string& cmd_name);

    CAlignAxesCommand(const string& cmd_name, const CEntityPtr& unit);
